...
const schemaData = {
  ...
  "award-option-types": [
    {value: 'sizes', text: 'Size'},
    {value: 'faces', text: 'Watch Face'},
    {value: 'straps', text: 'Watch Strap'},
    {value: 'engraving', text: 'Engraving'},
    {value: 'certificate', text: 'Name for the 25 Year Certificate'},
    {value: 'pecsfPool', text: 'Donate to PECSF Regional Pool Fund'},
    {value: 'pecsfRegion1', text: 'PECSF Region 1'},
    {value: 'pecsfCharity1', text: 'PECSF Charity (Region 1)'},
    {value: 'pecsfRegion2', text: 'PECSF Region 2'},
    {value: 'pecsfCharity2', text: 'PECSF Charity (Region 2)'},
    {value: 'honour', text: 'In Honour of'},
  ],
  "sort-by": [
